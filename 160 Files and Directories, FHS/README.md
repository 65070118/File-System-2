...
Filesystem Hierarchy Standard เป็นมาตรฐานลำดับชั้นที่ใช้ในการกำหนดโครงสร้างและเนื้อหาในระบบปฎิบัติการของ Linux โดยจะอธิบายว่า ไฟล์และไดเร็กทอรีควรมีอะไรบ้าง ทำให้โครงสร้างของระบบไฟล์นั้นเป็นระเบียบและเข้าถึงได้ง่าย โดยบางไดเร็กทอรี การจะเข้าถึงนั้นจะต้องใช้สิทธ์ของ root ในการเข้าถึง
