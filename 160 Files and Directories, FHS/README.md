...
เช่น การเปิดปิดไฟล์ การอ่านไฟล์ 

#### 2. Virtual File System (VFS) 
เป็นส่วนที่ช่วยให้ระบบ Physical File System นั้นสามารถทำงานพร้อมกันได้ 

#### 3. Physical File System 
ส่วนที่ทำหน้าที่ในการจัดการเกี่ยวกับบล็อกของหน่วความจำบน disk โดยการจัดเก็บและเรียกดูข้อมูลนั้น จะเป็นการโต้ตอบกับอุปกรณ์ฮาร์ดแวร์โดยตรง

และยังช่วยในการจัดสรรทรัพยากรที่ใช้ในการจัดเก็บข้อมูลให้มีประสิทธิภาพ 
