...
- **/dev**
  จะมีเฉพาะไฟล์ที่สำคัญเท่านั้น เช่น ไฟล์ต่างๆของอุปกรณ์ ซึ่งไฟล์เหล่านี้จะเป็นแค่ไฟล์เสมือนเท่านั้น ไม่ใช่ไฟล์จริงบนดิสก์เช่น (/dev/null, /dev/disk0, /dev/sda1, /dev/tty, /dev/random)
